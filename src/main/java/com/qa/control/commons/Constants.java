package com.qa.control.commons;

public class Constants {
	
	public final static String LOGINPAGE_TITLE = "IGT Control Login";
	public final static String HOMEPAGE_TITLE = "IGT Control";
	
	public static String DROP_DOWN_SEARCH_ITEM = "Contract Id";
	
	public static String USER_DETAIL_VIEW_MAIN = "View";
